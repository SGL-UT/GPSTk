...
*********************************************************************/
#include <stdio.h>
#include "xCNAV2gpsNavMsg.hpp"

CPPUNIT_TEST_SUITE_REGISTRATION (xCNAV2gpsNavMsg);

using namespace std;
using namespace gpstk;

void xCNAV2gpsNavMsg::setUp(void)
{
}
...
bool xCNAV2gpsNavMsg :: fileEqualTest (char* handle1, char* handle2)
{
	bool isEqual = false;
