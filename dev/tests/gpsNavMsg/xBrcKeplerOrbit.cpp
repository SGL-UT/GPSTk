...
int main( int argc, char * argv[] )
{
   ...
   BrcKeplerOrbit ko5( SysID, obsID, PRNID, beginFit, endFit, rToeCT, rURAoe,
   ...
   cout << "Position EE: " << xvt.x << endl;
   cout << "Velocity EE: " << xvt.v << endl;
   cout << "Relativity : " << EE.svRelativity( dt2 ) << endl; 
   ...
   cout << "Position EE: " << xvt.x << endl;
   cout << "Velocity EE: " << xvt.v << endl;
   cout << "Relativity : " << EE.svRelativity( dt3 ) << endl; 
   ...
   cout << "BeginFit ko1:      " << GPSWeekSecond(ko1.getBeginningOfFitInterval()).printf("%F, %g") << endl;
   cout << "BeginFit ko2:      " << GPSWeekSecond(ko2.getBeginningOfFitInterval()).printf("%F, %g") << endl;
   cout << "BeginFit ko3:      " << GPSWeekSecond(ko3.getBeginningOfFitInterval()).printf("%F, %g") << endl;
   cout << "BeginFit ko4:      " << GPSWeekSecond(ko4.getBeginningOfFitInterval()).printf("%F, %g") << endl;
   cout << "BeginFit ko5:      " << GPSWeekSecond(ko5.getBeginningOfFitInterval()).printf("%F, %g") << endl;
   cout << "BeginFit EE:       " << GPSWeekSecond(EE.getOrbit().getBeginningOfFitInterval()).printf("%F, %g") << endl;
   cout << "BeginFit EEload:   " << GPSWeekSecond(EEload.getOrbit().getBeginningOfFitInterval()).printf("%F, %g") << endl;
   cout << "BeginFit ESFload:  " << GPSWeekSecond(ESFload.getOrbit().getBeginningOfFitInterval()).printf("%F, %g") << endl;

   cout << endl;
   cout << "BeginFit EEA:    " << GPSWeekSecond(EEA.getOrbit().getBeginningOfFitInterval()).printf("%F, %g") << endl;
   cout << endl;

   cout << "EndFit ko1:      " << GPSWeekSecond(ko1.getEndOfFitInterval()).printf("%F, %g") << endl;
   cout << "EndFit ko2:      " << GPSWeekSecond(ko2.getEndOfFitInterval()).printf("%F, %g") << endl;
   cout << "EndFit ko3:      " << GPSWeekSecond(ko3.getEndOfFitInterval()).printf("%F, %g") << endl;
   cout << "EndFit ko4:      " << GPSWeekSecond(ko4.getEndOfFitInterval()).printf("%F, %g") << endl;
   cout << "EndFit ko5:      " << GPSWeekSecond(ko5.getEndOfFitInterval()).printf("%F, %g") << endl;
   cout << "EndFit EE:       " << GPSWeekSecond(EE.getOrbit().getEndOfFitInterval()).printf("%F, %g") << endl;
   cout << "EndFit EEload:   " << GPSWeekSecond(EEload.getOrbit().getEndOfFitInterval()).printf("%F, %g") << endl;
   cout << "EndFit ESFload:  " << GPSWeekSecond(ESFload.getOrbit().getEndOfFitInterval()).printf("%F, %g") << endl;

   cout << endl;
   cout << "EndFit EEA:      " << GPSWeekSecond(EEA.getOrbit().getEndOfFitInterval()).printf("%F, %g") << endl;

   cout << endl;   
   cout << "Within Fit Interval ko1: " << ko1.withinFitInterval(dt) << endl;
   cout << "Within Fit Interval ko2: " << ko2.withinFitInterval(dt) << endl;
   cout << "Within Fit Interval ko3: " << ko3.withinFitInterval(dt) << endl;
   cout << "Within Fit Interval ko4: " << ko4.withinFitInterval(dt) << endl;
   cout << "Within Fit Interval ko5: " << ko5.withinFitInterval(dt) << endl;
   cout << "Within Fit Interval EE:  " << EE.getOrbit().withinFitInterval(dt) << endl;
   cout << "Within Fit Interval EEA: " << EEA.getOrbit().withinFitInterval(dt2) << endl;
