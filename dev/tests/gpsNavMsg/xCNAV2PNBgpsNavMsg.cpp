...
*  and clock correction. The cppunit test module is used to test this
*  module.
*
*********************************************************************/
#include <stdio.h>
#include <math.h>
#include "xCNAV2PNBgpsNavMsg.hpp"

CPPUNIT_TEST_SUITE_REGISTRATION (xCNAV2PNBgpsNavMsg);

using namespace std;
using namespace gpstk;

void xCNAV2PNBgpsNavMsg::setUp(void)
{
}
...
bool xCNAV2PNBgpsNavMsg :: fileEqualTest (char* handle1, char* handle2)
{
	bool isEqual = false;
