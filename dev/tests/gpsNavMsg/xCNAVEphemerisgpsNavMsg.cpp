...
*********************************************************************/
#include <stdio.h>
#include "xCNAVEphemerisgpsNavMsg.hpp"

CPPUNIT_TEST_SUITE_REGISTRATION (xCNAVEphemerisgpsNavMsg);

using namespace std;
using namespace gpstk;

void xCNAVEphemerisgpsNavMsg::setUp(void)
{
}

void xCNAVEphemerisgpsNavMsg::firstTest(void)
{
...
bool xCNAVEphemerisgpsNavMsg :: fileEqualTest (char* handle1, char* handle2)
{
	bool isEqual = false;
