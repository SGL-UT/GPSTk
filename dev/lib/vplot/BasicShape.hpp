#pragma ident "$Id: //depot/msn/r5.3/wonky/gpstkplot/lib/draw/BasicShape.hpp#2 $"
...
#ifndef VPLOT_BASICSHAPE_H
#define VPLOT_BASICSHAPE_H
...
namespace vplot
{
   ...
   public:
      ...
      bool hasOwnStrokeStyle(void) const { return hasLineStyle; }

      /// Accessor. What is the style associated with this basic shape
      StrokeStyle getStrokeStyle(void) const { return lineStyle; }
      
      /// Mutator. Set the stroke style
      void setStrokeStyle(const StrokeStyle& istyle) { lineStyle=istyle;hasLineStyle=true; }  

      /// Mutator. Remove the stroke style...use default
      void removeStrokeStyle(void) { hasLineStyle=false; }
