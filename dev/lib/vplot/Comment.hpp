#pragma ident "$Id: //depot/msn/r5.3/wonky/gpstkplot/lib/draw/Comment.hpp#2 $"

/// @file Comment.hpp Defines a comment like printf. Class declarations.
...
#ifndef VPLOT_COMMENT_H
#define VPLOT_COMMENT_H
