...
{
	ANSITime GPS1(13500000,GPS);
	ANSITime GPS2(13400000,GPS);
	ANSITime UTC1(13500000,UTC);
	ANSITime UNKNOWN(13500000,Unknown);
	ANSITime ANY(13500000,Any);
