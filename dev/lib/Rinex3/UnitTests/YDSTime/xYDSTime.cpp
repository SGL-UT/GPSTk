...
void xYDSTime :: timeSystemTest (void)
{
	...
	YDSTime GPS1(2008,2,1,GPS);
	YDSTime GPS2(2005,2,1,GPS);
	YDSTime UTC1(2008,2,1,UTC);
	YDSTime UNKNOWN(2008,2,1,Unknown);
	YDSTime ANY(2008,2,1,Any);
