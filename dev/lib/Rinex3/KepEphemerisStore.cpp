...
/**
 * @file KepEphemerisStore.cpp
 * Store & access a list of SV pvts
 */

#include "KepEphemerisStore.hpp"
...
namespace gpstk
{
   //--------------------------------------------------------------------------
   //--------------------------------------------------------------------------
   void KepEphemerisStore::dump(std::ostream& s, short detail)
      const throw()
   {
      s << "Dump of KepEphemerisStore:" << std::endl;
      if(detail >= 0) {
   ...
   } // end of KepEphemerisStore::dump


   //--------------------------------------------------------------------------
   //--------------------------------------------------------------------------
   void KepEphemerisStore::edit(const DayTime& tmin, const DayTime& tmax)
      throw()
   {
      EphMap::iterator kt;
      ...
      initialTime = tmin;
      finalTime = tmax;
   }  // end KepEphemerisStore::edit


   //--------------------------------------------------------------------------
   //--------------------------------------------------------------------------
   // Remove all data
   void KepEphemerisStore::clear()
      throw()
   {
      pe.clear();
   ...
   //--------------------------------------------------------------------------
   //--------------------------------------------------------------------------
   Xvt KepEphemerisStore::getXvt(const SatID sat, const DayTime& t)
   ...
   }  // end Xvt KepEphemerisStore::getSatXvt


   //-----------------------------------------------------------------------------
   //-----------------------------------------------------------------------------
   void KepEphemerisStore::addEphemeris(const SP3Data& data)
      throw()
   {
      DayTime t = data.time;
      SatID sat = data.sat;
