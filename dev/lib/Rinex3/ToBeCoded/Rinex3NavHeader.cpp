 ...
 * Encapsulate header of Rinex3 navigation file
 */
...
namespace gpstk
{
   ...
   const string Rinex3NavHeader::deltaUTCString = "DELTA-UTC: A0,A1,T,W";
   const string Rinex3NavHeader::ionBetaString = "ION BETA";
   const string Rinex3NavHeader::ionAlphaString = "ION ALPHA";
   const string Rinex3NavHeader::commentString = "COMMENT";
   const string Rinex3NavHeader::runByString = "PGM / RUN BY / DATE";
   const string Rinex3NavHeader::versionString = "RINEX3 VERSION / TYPE";
      ...
      throw(std::exception, FFStreamError, StringException)
   {
      ...
      {
         FFStreamError err("Unknown RINEX3 version: " + asString(version,3));
      ...
      while (! (valid & endValid))
      {
         ...
         if (thisLabel == versionString)
         {
            ...
            if ( (fileType[0] != 'N') &&
                 (fileType[0] != 'n'))
            {
               FFStreamError e("This isn't a Rinex3 Nav file");
               GPSTK_THROW(e);
            }
            valid |= versionValid;
         }
