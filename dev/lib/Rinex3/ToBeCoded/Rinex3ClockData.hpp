...
namespace gpstk
{
       ...
       * @sa rinex_clock_test.cpp and rinex_clock_read_write.cpp for examples.
       */
   ...
   public:
      ...
      Rinex3ClockData(): time(gpstk::DayTime::BEGINNING_OF_TIME){}
      ...
      std::string name;
         ///< the GPS time corresponding to the clock data record
      DayTime time;
