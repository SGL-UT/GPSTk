...
/**
 * @file Rinex3MetHeader.hpp
 * Encapsulate header of Rinex3 meteorological file data, including I/O
 */

#ifndef GPSTK_RINEX3METHEADER_HPP
#define GPSTK_RINEX3METHEADER_HPP
...
namespace gpstk
{
   ...
   //@{
      ...
      /**
       * This class models the RINEX3 MET header for a RINEX3 MET file.
       * When writing data, this class determines what data gets written from
       * a Rinex3MetData object to the Rinex3MetStream.
       *
       * @sa rinex_met_read_write.cpp for an example.
       * @sa rinex_met_test.cpp for an example.
       * @sa Rinex3MetHeader::obsTypeList for writing files.
       * @sa Rinex3MetData and Rinex3MetStream.
       */
   class Rinex3MetHeader : public Rinex3MetBase
   {
   public:
	 ...
	 HI         ///< Hail indicator non-zero: Hail detected since last mesaurement
         ...
         /// Constructor
      Rinex3MetHeader() : valid(0), version(3.0) {}

         /// Destructor
      virtual ~Rinex3MetHeader() {}

         // The next four lines is our common interface
         /// Rinex3MetHeader is a "header" so this function always returns true.
      ...
      static Rinex3MetType convertObsType(const std::string& oneObs) 
         throw(FFStreamError);
      
         /// Converts a Rinex3MetType to its string equivalent.
      static std::string convertObsType(const Rinex3MetType& oneObs)
         throw(FFStreamError);
   
         /// Tell me, Am I valid?
      unsigned long valid;

         /// These are validity bits used in checking the RINEX3 MET header.
      enum validBits
      {
         versionValid = 0x01,        ///< Set if the RINEX3 version is valid.
         ...
         endValid = 0x080000000,          ///< Set if the end value is valid.
            ...
            /// available for a Rinex3.0 file
         allValid30 = 0x0800000EB,
      };
      ...
      static inline std::string bitsAsString(validBits b)
      {
         ...
         /* @return a string composed the RINEX3 header strings
          ...
          * @param quote quote character to use around RINEX3 header strings.
      ...
      struct sensorType
      {
         ...
         Rinex3MetType obsType; ///< The obs type this sensor corresponds to.
      };
      ...
      struct sensorPosType
      {
         ...
         Rinex3MetType obsType;
      };

         /** @name HeaderValues
          */
         //@{
      double version;           ///< RINEX3 Version
      ...
      std::string markerNumber;                  ///< The number of the location
          ...
          * an output Rinex3ObsStream.  Set this with the Rinex3MetTypes 
          * that you want written to the file.
          */
      std::vector<Rinex3MetType> obsTypeList;
   ...
   protected:
         /// Writes the RINEX3 Met header to the stream \a s.
      virtual void reallyPutRecord(FFStream& s) const 
         throw(std::exception, FFStreamError,
               gpstk::StringUtils::StringException);

         /**
          * This function reads the RINEX3 MET header from the given FFStream.
