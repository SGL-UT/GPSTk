...
/**
 * @file Rinex3MetData.hpp
 * Encapsulate RINEX3 meteorological file data, including I/O
 */

#ifndef GPSTK_RINEX3METDATA_HPP
#define GPSTK_RINEX3METDATA_HPP
...
namespace gpstk
{
   ...
   //@{
      ...
      /** 
       * This class stores, reads, and writes RINEX3 MET records. 
       * @warning When writing a Rinex3MetData, the Rinex3MetStream::headerData
       ...
       */
   class Rinex3MetData : public Rinex3MetBase
   {
   ...
   public:
      Rinex3MetData()
         ...
         /// Rinex3MetData is "data" so this function always returns true.
      ...
      bool operator<(const Rinex3MetData& right) const
         { return (time < right.time); }

         /// A map for storing one line of observations, mapping
         /// the observation type to its value.
      typedef std::map<Rinex3MetHeader::Rinex3MetType, double> Rinex3MetMap;

         /** @name Rinex3 weather data
          */
         //@{
      CommonTime time;      ///< The time this data was recorded.
      Rinex3MetMap data;  ///< The data itself in map form.
         //@}
   ...
   protected:
      ...
      void reallyPutRecord(FFStream& s) const
         ...
         /** 
          * This function retrieves a RINEX3 MET record from the given FFStream.
