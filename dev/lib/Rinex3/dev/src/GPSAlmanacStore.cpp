#pragma ident "$Id: GPSAlmanacStore.cpp 856 2007-10-31 02:39:46Z ocibu $"
...
namespace gpstk
{
   Xvt GPSAlmanacStore::getXvt(const SatID sat, const CommonTime& t) const
   ...
   short GPSAlmanacStore::getSatHealth(const SatID sat, const CommonTime& t) const
      throw( gpstk::InvalidRequest )
   {
      AlmOrbit a = findAlmanac(sat, t);
   ...
   bool GPSAlmanacStore::addAlmanac(const AlmOrbit& alm)
      throw()
   {
   ...
   bool GPSAlmanacStore::addAlmanac(const EngAlmanac& alm)
      throw()
   {
