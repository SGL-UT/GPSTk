...
namespace gpstk
{
    ...
    // Method to store load ocean tide harmonics data in this class' data map
    void BLQDataReader::loadData(void) throw(FFStreamError, gpstk::StringUtils::StringException)
    {
