...
namespace gpstk
{
   ...
   RinexNavData::RinexNavData(const EngEphemeris& ee) // GPS only
   {
      // epoch info
...
//      BGDb = ee.getBGDb(); // Galileo only
   ...
   }  // End of 'RinexNavData::RinexNavData(const EngEphemeris& ee)'


      // This constructor initializes R3NavData with Galileo data.
      // Refer to previous constructor, RinexNavData(const EngEphemeris& ee),
      // for more information on which elements are GPS and/or Galileo only.
   RinexNavData::RinexNavData(const GalEphemeris& ge)
   {
      // epoch info
   ...
   }  // End of 'RinexNavData::RinexNavData(const GalEphemeris& ge)'


      // This constructor initializes R3NavData with Glonass data.
   RinexNavData::RinexNavData(const GloEphemeris& gloe)
   {
   ...
   }  // End of 'RinexNavData::RinexNavData(const GloEphemeris& ge)'
   ...
   }  // End of method 'RinexNavData::reallyGetRecord(FFStream& ffs)'
   ...
   }  // End of method 'RinexNavData::reallyPutRecord(FFStream& ffs)'
   ...
   }  // End of method 'RinexNavData::dump(ostream& s)'


// This is the old converter from RinexNavData to EngEphemeris. The new one is below
 ...
 *     return ee;
 *
 *  }  // End of 'RinexNavData::operator EngEphemeris()'
 */
   ...
   RinexNavData::operator EngEphemeris() const throw()
   {
      ...
      // Converts this RinexNavData to a GalEphemeris object.
   RinexNavData::operator GalEphemeris() const throw()
   {
   ...
   }  // End of 'RinexNavData::operator GalEphemeris()'


      // Converts this RinexNavData to a GloEphemeris object.
   RinexNavData::operator GloEphemeris() const throw()
   {
   ...
   }  // End of 'RinexNavData::operator GloEphemeris()'
   ...
   }  // End of method 'RinexNavData::toList()'


      /* Generates the PRN/epoch line and outputs it to strm
       *  @param strm RINEX Nav stream
       */
   void RinexNavData::putPRNEpoch(RinexNavStream& strm) const
      throw(StringException)
   {
   ...
   }  // End of 'RinexNavData::putPRNEpoch(RinexNavStream& strm)'
       ...
       *  @param RinexNavStream strm  Stream to read from.
       */
   void RinexNavData::putRecord(const int& nline, RinexNavStream& strm) const
      throw(StringException, FFStreamError)
   {
      ...
      try {
         ...
         if(nline == 1) {
            ...
            // Internally (RinexNavData and EngEphemeris), weeknum=week of HOW
   ...
   }  // End of method 'RinexNavData::putRecord(const int& nline,...'


   void RinexNavData::getPRNEpoch(RinexNavStream& strm)
      throw(StringException, FFStreamError)
   {
      try {
         int i;
   ...
   void RinexNavData::getRecord(const int& nline, RinexNavStream& strm)
      throw(StringException, FFStreamError)
   {
      if(nline < 1 || nline > 7) {
         FFStreamError fse(string("Invalid line number ") + asString(nline));
