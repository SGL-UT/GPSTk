...
namespace gpstk
{
   ...
   struct RinexNavDataOperatorLessThanFull :
      public std::binary_function<RinexNavData, RinexNavData, bool>
   {
   public:

     bool operator()(const RinexNavData& l, const RinexNavData& r) const
     {
   ...
   /// RinexNavHeader, the internal theHeader will be the merged header
   /// data for those files.
   struct RinexNavHeaderTouchHeaderMerge :
      public std::unary_function<RinexNavHeader, bool>
   {
   public:
     ...
     bool operator()(const RinexNavHeader& l)
     {
       if (firstHeader)
       {
         theHeader = l;
     ...
     bool firstHeader;
     RinexNavHeader theHeader;
   };

   /// Filter based on PRN ID.
   struct RinexNavDataFilterPRN :
      public std::unary_function<RinexNavData, bool>
   {
   public:
     ...
     bool operator()(const RinexNavData& l) const
     {
