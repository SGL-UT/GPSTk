...
namespace gpstk
{
    ...
    const double MoonPosition::ELP0(270.434164), MoonPosition::ELP1(481267.8831), MoonPosition::ELP2(-0.001133), MoonPosition::ELP3(0.0000019);

    // Sun's mean anomaly
    const double MoonPosition::EM0(358.475833), MoonPosition::EM1(35999.0498), MoonPosition::EM2(-0.000150), MoonPosition::EM3(-0.0000033);

    // Moon's mean anomaly
    const double MoonPosition::EMP0(296.104608), MoonPosition::EMP1(477198.8491), MoonPosition::EMP2(0.009192), MoonPosition::EMP3(0.0000144);

    // Moon's mean elongation
    const double MoonPosition::D0(350.737486), MoonPosition::D1(445267.1142), MoonPosition::D2(-0.001436), MoonPosition::D3(0.0000019);

     // Mean distance of the Moon from its ascending node
    const double MoonPosition::F0(11.250889), MoonPosition::F1(483202.0251), MoonPosition::F2(-0.003211), MoonPosition::F3(-0.0000003);

    // Longitude of the Moon's ascending node
    const double MoonPosition::OM0(259.183275), MoonPosition::OM1(-1934.1420), MoonPosition::OM2(0.002078), MoonPosition::OM3(0.0000022);


    // Coefficients for (dimensionless) E factor
    const double MoonPosition::E1(-0.002495), MoonPosition::E2(-0.00000752);

    // Coefficients for periodic variations, etc
    const double MoonPosition::PAC(0.000233), MoonPosition::PA0(51.2), MoonPosition::PA1(20.2);
    const double MoonPosition::PBC(-0.001778);
    const double MoonPosition::PCC(0.000817);
    const double MoonPosition::PDC(0.002011);
    const double MoonPosition::PEC(0.003964), MoonPosition::PE0(346.560), MoonPosition::PE1(132.870), MoonPosition::PE2(-0.0091731);
    ...
    //
    const size_t MoonPosition::NL(50), MoonPosition::NB(45), MoonPosition::NP(31);
    Vector<double> MoonPosition::TL(NL,0.0), MoonPosition::TB(NB,0.0), MoonPosition::TP(NP,0.0);
    Matrix<int> MoonPosition::ITL(5,NL,0), MoonPosition::ITB(5,NB,0), MoonPosition::ITP(5,NP,0);
    ...
    Triple MoonPosition::getPosition(const DayTime& t) const throw(InvalidRequest)
    {
        ...
        if ( (t < MoonPosition::initialTime) || (t > MoonPosition::finalTime) )
        {
