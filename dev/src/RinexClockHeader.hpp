...
namespace gpstk
{
   ...
   public:
      ...
      //static const std::vector<ObsID> StandardRinexObsIDs;
      //static std::vector<ObsID> RegisteredRinexObsIDs;
   ...
   //@}
      ...
      virtual ~RinexClockHeader() {}
         ...
         /// RinexClockHeader is a "header" so this function 
         /// always returns true.
      ...
      virtual void dump(std::ostream& s) const;
          ...
          * Used by reallyGetRecord for both RinexClockHeader and 
          * RinexClockData.
          */
