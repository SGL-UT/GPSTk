...
namespace gpstk
{
   ...
   public:
      ...
      void dump(std::ostream& s, RinexObsHeader& head) const;
   ...
   protected:
      ...
      virtual void reallyPutRecord(FFStream& s) const 
          ...
          *
          *  Because of the Rinex 3 Obs format, a RinexObsData record returned
          *  might not have data.  Check the RinexSatMap for empty() before
