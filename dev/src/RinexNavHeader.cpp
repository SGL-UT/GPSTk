...
namespace gpstk
{
   const string RinexNavHeader::stringVersion     = "RINEX VERSION / TYPE";
   const string RinexNavHeader::stringRunBy       = "PGM / RUN BY / DATE";
   const string RinexNavHeader::stringComment     = "COMMENT";
   const string RinexNavHeader::stringIonoCorr    = "IONOSPHERIC CORR";
   const string RinexNavHeader::stringTimeSysCorr = "TIME SYSTEM CORR";
   const string RinexNavHeader::stringLeapSeconds = "LEAP SECONDS";
   const string RinexNavHeader::stringCorrSysTime = "CORR TO SYSTEM TIME"; //R2.10GLO
   const string RinexNavHeader::stringDeltaUTC    = "DELTA-UTC: A0,A1,T,W";//R2.11GPS
   const string RinexNavHeader::stringDUTC        = "D-UTC A0,A1,T,W,S,U"; //R2.11GEO
   const string RinexNavHeader::stringIonAlpha    = "ION ALPHA";           //R2.11
   const string RinexNavHeader::stringIonBeta     = "ION BETA";            //R2.11
   const string RinexNavHeader::stringEoH         = "END OF HEADER";
