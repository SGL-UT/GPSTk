...
%{
   ...
   #include "../../../lib/Procframe/Antenna.hpp"
  ...
  // #include "../../../lib/Rxio/EphReader.hpp"
   ...
   #include "../../../lib/PosSol/Bancroft.hpp"
   #include "../../../lib/Utilities/ValidType.hpp"
   #include "../../../lib/ClockModel/ObsEpochMap.hpp"
   #include "../../../lib/GNSSCore/WxObsMap.hpp"
   #include "../../../lib/GNSSCore/TropModel.hpp"
   #include "../../../lib/Procframe/CheckPRData.hpp"
   #include "../../../lib/PosSol/PRSolution2.hpp"
   #include "../../../lib/Procframe/ExtractData.hpp"
