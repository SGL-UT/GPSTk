...
- > https://repositories.arlut.utexas.edu/sgl/gpstk/-/merge_requests/449
- Update OceanLoadTides.hpp Add reference to SPOTL in doxygen comments
- > https://repositories.arlut.utexas.edu/sgl/gpstk/-/merge_requests/453
- Refactor gpstk pipeline downstream jobs
- > https://repositories.arlut.utexas.edu/sgl/gpstk/-/merge_requests/451
- Refactor debian dpkg-buildpackage Update control files to remove python bindings
- > https://repositories.arlut.utexas.edu/sgl/gpstk/-/merge_requests/450
- Refactor debian8 remove python bindings
- > https://repositories.arlut.utexas.edu/sgl/gpstk/-/merge_requests/421
...
- > https://repositories.arlut.utexas.edu/sgl/gpstk/-/merge_requests/447
- Add SatMetaDataStore findSatByFdmaSlot
- > https://repositories.arlut.utexas.edu/sgl/gpstk/-/merge_requests/443
- Add Documentation Artifact to CI Pipeline
- > https://repositories.arlut.utexas.edu/sgl/gpstk/-/merge_requests/446
- Refactor Yuma/SEM file support back into ext
- > https://repositories.arlut.utexas.edu/sgl/gpstk/-/merge_requests/445
- Fix core/lib include statements to search GPSTk include directory.
- > https://repositories.arlut.utexas.edu/sgl/gpstk/-/merge_requests/444
- Fix OrbSysGpsL_55 Restore output of text message
- > https://repositories.arlut.utexas.edu/sgl/gpstk/-/merge_requests/442
- Fix various pieces of code to resolve warning messages on various platforms.
- > https://repositories.arlut.utexas.edu/sgl/gpstk/-/merge_requests/439
- Add CODEOWNERS file.
- -09-14 15:15:13,841 WARNING  root Detected gpstk repository.
- sh', '-c', 'git remote -v | head -n 1 | grep -oP "(?<=sgl/).*(?=.git)"']
