...
========================================================================================================================= */
	int  initializationTest (void)
	{
		...
		//=====================================================================
		//Was the time system set to expectation?
		//=====================================================================
		...
		CivilTime Assigned;
		Assigned = Compare;
		testFramework.changeSourceMethod("Equals Operator");
		//=====================================================================
		//Was the time system set to expectation?
		//=====================================================================
		testFramework.assert(TimeSystem(2) == Assigned.getTimeSystem(), "Equals Operator did not set the TimeSystem properly", __LINE__);

		//=====================================================================
		//Was the year value set to expectation?
		//=====================================================================
		testFramework.assert(2008 == (int)Assigned.year, "Equals Operator did not set the year properly", __LINE__);

		//=====================================================================
		//Was the month value set to expectation?
		//=====================================================================
		testFramework.assert(8 == (int)Assigned.month, "Equals Operator did not set the month properly", __LINE__);

		//=====================================================================
		//Was the day value set to expectation?
		//=====================================================================
		testFramework.assert(21 == (int)Assigned.day, "Equals Operator did not set the day properly", __LINE__);

		//=====================================================================
		//Was the hour value set to expectation?
		//=====================================================================
		testFramework.assert(13 == (int)Assigned.hour, "Equals Operator did not set the hour properly", __LINE__);

		//=====================================================================
		//Was the minute value set to expectation?
		//=====================================================================
		testFramework.assert(30 == (int)Assigned.minute, "Equals Operator did not set the mimute properly", __LINE__); 

		//=====================================================================
		//Was the second value set to expectation?
		//=====================================================================
		testFramework.assert(15 == (double)Assigned.second, "Equals Operator did not set the second properly", __LINE__); 
...
========================================================================================================================= */
	int operatorTest (void)
	{
		...
		testFramework.changeSourceMethod("NotEqual Operator");
		//=====================================================================
		//Are non-equivalent objects non-equivalent?
		//=====================================================================
		...
		//=====================================================================
		//Are equivalent objects non-equivalent?
		//=====================================================================
		...
		//=====================================================================
		//Does the < operator function when left_obj < right_obj
		//=====================================================================
...
========================================================================================================================= */
	int  toFromCommonTimeTest (void)
	{
		...
		//=====================================================================
		testFramework.assert(Test2 == Aug21, "Time provided found to be different after converting to and from CommonTime", __LINE__);

		//=====================================================================
		//Is the time system after conversion what is expected?
		//=====================================================================
		testFramework.assert(Aug21.getTimeSystem()==TimeSystem(2), "TimeSystem provided found to be different after converting to and from CommonTime", __LINE__);

		//=====================================================================
		//Is the year after conversion what is expected?
		//=====================================================================
  		testFramework.assert(2008 == (int)Aug21.year, "Year provided found to be different after converting to and from CommonTime", __LINE__);
		//=====================================================================
		//Is the month after conversion what is expected?
		//=====================================================================
  		testFramework.assert(8 == (int)Aug21.month, "Month provided found to be different after converting to and from CommonTime", __LINE__);

		//=====================================================================
		//Is the day after conversion what is expected?
		//=====================================================================
  		testFramework.assert(21 == (int)Aug21.day, "Day provided found to be different after converting to and from CommonTime", __LINE__);

		//=====================================================================
		//Is the hour after conversion what is expected?
		//=====================================================================
  		testFramework.assert(13 == (int)Aug21.hour, "Hour provided found to be different after converting to and from CommonTime", __LINE__);

		//=====================================================================
		//Is the minute after conversion what is expected?
		//=====================================================================
  		testFramework.assert(30 == (int)Aug21.minute, "Minute provided found to be different after converting to and from CommonTime", __LINE__);

		//=====================================================================
		//Is the second after conversion what is expected?
		//=====================================================================
  		testFramework.assert(15 == (int)Aug21.second, "Second provided found to be different after converting to and from CommonTime", __LINE__);		
...
========================================================================================================================= */
	...
	{
  		TestUtil testFramework( "CivilTime", "Equivalence Operator With Different TimeSystems", __FILE__, __LINE__ );
		...
		//=====================================================================
		//Verify differign TimeSystem sets equivalence operator to false
		...
		testFramework.assert(GPS1 == ANY, "Differing TimeSystems where one is TimeSystem::Any is not ignored", __LINE__);
		testFramework.assert(UTC1 == ANY, "Differing TimeSystems where one is TimeSystem::Any is not ignored", __LINE__);
		testFramework.assert(UNKNOWN == ANY, "Differing TimeSystems where one is TimeSystem::Any is not ignored", __LINE__);

		testFramework.changeSourceMethod("NotEqual Operator With Differing TimeSystems");
		//=====================================================================
		...
		testFramework.changeSourceMethod("LessThan Operator With Differing TimeSystems");	
		//=====================================================================
