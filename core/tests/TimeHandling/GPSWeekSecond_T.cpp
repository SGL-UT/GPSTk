...
//==========================================================================================================================
   int  printfTest (void)
   {
      ...
      GPSWeekSecond UTC1(1300,13500.,TimeSystem(7));
         ...
         //--------------------------------------------------------------------
      testFramework.assert_equals<string>("1300 13500.000000 GPS", GPS1.printf("%04F %05g %02P"), __LINE__);
      testFramework.assert_equals<string>("1300 13500.000000 UTC", UTC1.printf("%04F %05g %02P"), __LINE__);
      ...
      testFramework.changeSourceMethod("printError");
         ...
         //--------------------------------------------------------------------
      testFramework.assert_equals<string>("BadGPSepoch BadGPSmweek BadGPSdow BadGPSfweek BadGPSsow BadGPSsys", GPS1.printError("%E %G %w %04F %05g %02P"), __LINE__);
      testFramework.assert_equals<string>("BadGPSepoch BadGPSmweek BadGPSdow BadGPSfweek BadGPSsow BadGPSsys", UTC1.printError("%E %G %w %04F %05g %02P"), __LINE__);
...
int main() //Main function to initialize and run all tests above
{
	...
	cout << "Total Failures for " << __FILE__ << ": " << errorCounter
             << endl;
