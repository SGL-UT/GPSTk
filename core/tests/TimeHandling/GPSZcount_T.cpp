...
//==========================================================================================================================
	int  initializationTest(void)
	{
		...
		//----------------------------------------------------------------------------------------------
		//Were the values set to expectation using the explicit constructor with week and zcount inputs?
		//----------------------------------------------------------------------------------------------
		...
		//----------------------------------------------------------------------------------------------
		//Were the values set to expectation using the explicit constructor with FullZcount input?
		//----------------------------------------------------------------------------------------------
...
//==========================================================================================================================
//	differenceTest ensures the functionality of the Subtraction operator between two GPSZcount objects
//==========================================================================================================================
...
//==========================================================================================================================
//	inSameTimeBlockTest ensures the functionality of the inSameTimeBlock method
//==========================================================================================================================
	int inSameTimeBlockTest(void)
	{
		...
		//For times at 1 week, the comparison is done assuming close to week = 0, which is not any of these
		...
		testFramework.assert(isAtWeek            , "Returned false when object difference is 403200 and timeblock is 403200"        , __LINE__);	
