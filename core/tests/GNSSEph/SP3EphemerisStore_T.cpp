...
void xSP3EphemerisStore :: SP3getXvtTest (void)
{
	...
	fPRN1.open ("SP3_Logs/findXvt1.txt");
	fPRN15.open ("SP3_Logs/findXvt15.txt");
	fPRN31.open ("SP3_Logs/findXvt31.txt");
	...
	CPPUNIT_ASSERT(fileEqualTest((char*)"SP3_Logs/findXvt1.txt",(char*)"SP3_Checks/findXvt1.txt"));
	CPPUNIT_ASSERT(fileEqualTest((char*)"SP3_Logs/findXvt15.txt",(char*)"SP3_Checks/findXvt15.txt"));
	CPPUNIT_ASSERT(fileEqualTest((char*)"SP3_Logs/findXvt31.txt",(char*)"SP3_Checks/findXvt31.txt"));
