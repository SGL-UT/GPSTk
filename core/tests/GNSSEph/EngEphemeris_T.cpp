...
//=======================================================================
   ...
   void subframe1Check(gpstk::EngEphemeris dataStore, TestUtil& testFramework,
   ...
   void subframe2Check(gpstk::EngEphemeris dataStore, TestUtil& testFramework,
                       bool skipASAlert = false)
   {
   ...
   void subframe3Check(gpstk::EngEphemeris dataStore, TestUtil& testFramework,
                       bool skipASAlert = false)
   {
   ...
   {
      TestUtil testFramework("EngEphemeris", "Default Constructor", __FILE__,
                             __LINE__);
      int badCount = 0;
   ...
   {
      TestUtil testFramework("EngEphemeris", "addSubframeNoParity", __FILE__,
                             __LINE__);
