...
NavID_T()
      : testIDLNAV(SatID(1, SatelliteSystem::GPS),
                   ObsID(ObsID::otNavMsg, CarrierBand::L1, ObsID::tcCA)),
        testIDCNAVL2(SatID(1, SatelliteSystem::GPS),
                     ObsID(ObsID::otNavMsg, CarrierBand::L2, ObsID::tcC2LM)),
        testIDCNAVL5(SatID(1, SatelliteSystem::GPS),
                     ObsID(ObsID::otNavMsg, CarrierBand::L5, ObsID::tcI5)),
        testIDCNAV2(SatID(1, SatelliteSystem::GPS),
                    ObsID(ObsID::otNavMsg, CarrierBand::L1, ObsID::tcG1X)),
        testIDMNAV(SatID(1, SatelliteSystem::GPS),
                   ObsID(ObsID::otNavMsg, CarrierBand::L2, ObsID::tcM)),
        testIDBD1(SatID(6, SatelliteSystem::BeiDou),
                  ObsID(ObsID::otNavMsg, CarrierBand::B1, ObsID::tcCI1)),
        testIDBD2(SatID(5, SatelliteSystem::BeiDou),
                  ObsID(ObsID::otNavMsg, CarrierBand::B2, ObsID::tcCI1)),
        testIDGloF(SatID(2, SatelliteSystem::Glonass),
                   ObsID(ObsID::otNavMsg, CarrierBand::G1, ObsID::tcGCA)),
        testIDGloC(SatID(2, SatelliteSystem::Glonass),
                   ObsID(ObsID::otNavMsg, CarrierBand::G3, ObsID::tcIQR3)),
        testIDGalOS(SatID(2, SatelliteSystem::Galileo),
                    ObsID(ObsID::otNavMsg, CarrierBand::L1, ObsID::tcB)),
        testIDGalOS_2(SatID(2, SatelliteSystem::Galileo),
                      ObsID(ObsID::otNavMsg, CarrierBand::E5b, ObsID::tcIE5b)),
        testIDGalOS_F(SatID(2, SatelliteSystem::Galileo),
                      ObsID(ObsID::otNavMsg, CarrierBand::L5, ObsID::tcIE5a)),
        testID_IRNSS_SPS(SatID(2, SatelliteSystem::IRNSS),
                         ObsID(ObsID::otNavMsg, CarrierBand::L5, ObsID::tcIA5)),
        testIDUnkwn(SatID(1, SatelliteSystem::GPS),
                    ObsID(ObsID::otNavMsg, CarrierBand::L5, ObsID::tcM))
{
}
