...
realDataTest()
{
   ...
   ObsID obsID( ObsID::otNavMsg, CarrierBand::L1, TrackingCode::CA );
   std::string rxID = "rx1";
...
equalityTest()
{
   ...
   ObsID obsID( ObsID::otNavMsg, CarrierBand::L2, TrackingCode::C2LM );
   NavID navID(satID,obsID);
   std::string rxID = "rx1";
   CommonTime ct = CivilTime( 2011, 6, 2, 12, 14, 44.0, TimeSystem::GPS );

   SatID satID2(2, SatelliteSystem::GPS);
   ObsID obsID2(ObsID::otNavMsg, CarrierBand::L5, TrackingCode::Q5 );
