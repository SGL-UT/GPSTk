...
public:
   ...
   int addSubframeTest(void)
   {
      ...
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[0], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 2 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[1], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 3 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[2], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 4 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[3], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 5 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[4], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 6 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[5], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 7 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[6], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 8 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[7], 819), testMesg, __LINE__);
      ...
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[8], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 11 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[9], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 12 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[10], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 13 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[11], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 14 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[12], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 15 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[13], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 16 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[14], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 17 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[15], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 18 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[16], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 19 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[17], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 20 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[18], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 21 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[19], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 22 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[20], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 23 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[21], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 5 page 24 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[22], 819), testMesg, __LINE__);

      testMesg = "Adding subframe 4 page 2 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[23], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 4 page 3 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[24], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 4 page 4 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[25], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 4 page 5 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[26], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 4 page 7 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[27], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 4 page 8 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[28], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 4 page 9 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[29], 819), testMesg, __LINE__);
      testMesg = "Adding subframe 4 page 10 failed";
      testFramework.assert(alm.addSubframe(aSubframes.totalSf[30], 819), testMesg, __LINE__);
...
*/
      ...
      for (int i=0; i<31; i++)
      {
         ...
         if (!(std::abs(alm.getEcc(gpstk::SatID(x, gpstk::SatID::systemGPS)) - aData.ecc[i])*1E2 < eps))
            failCount++;
      }
      testMesg = "getEcc returned the wrong value";
      ...
      for (int i=0; i<31; i++)
      {
         ...
         if (!(std::abs(alm.getIOffset(gpstk::SatID(x, gpstk::SatID::systemGPS)) - (aData.oi[i] - .3*M_PI)) < eps))
            failCount++;
      }
      testMesg = "getIOffset returned the wrong value";
      testFramework.assert(failCount == 0, testMesg, __LINE__);
      ...
      for (int i=0; i<31; i++)
      {
         ...
         if (!(std::abs(alm.getOmegadot(gpstk::SatID(x, gpstk::SatID::systemGPS)) - aData.rora[i])*1E8 < eps))
            failCount++;
      }
      testMesg = "getOmegadot returned the wrong value";
      testFramework.assert(failCount == 0, testMesg, __LINE__);
      ...
      for (int i=0; i<31; i++)
      {
         ...
         if (!(std::abs(alm.getAhalf(gpstk::SatID(x, gpstk::SatID::systemGPS)) - aData.sqrta[i])*1E-4 < eps))
            failCount++;
      }
      testMesg = "getAhalf returned the wrong value";
      testFramework.assert(failCount == 0, testMesg, __LINE__); 
      ...
      for (int i=0; i<31; i++)
      {
         ...
         if (!(std::abs(alm.getA(gpstk::SatID(x, gpstk::SatID::systemGPS)) - pow(aData.sqrta[i],2))*1E-8 < eps))
            failCount++;
      }
      testMesg = "getA returned the wrong value";
      testFramework.assert(failCount == 0, testMesg, __LINE__);
      ...
      for (int i=0; i<31; i++)
      {
         ...
         if (!(std::abs(alm.getOmega0(gpstk::SatID(x, gpstk::SatID::systemGPS)) - aData.raaw[i])*1E-1 < eps))
            failCount++;
      }
      testMesg = "getOmega0 returned the wrong value";
      testFramework.assert(failCount == 0, testMesg, __LINE__);
      ...
      for (int i=0; i<31; i++)
      {
         ...
         if (!(std::abs(alm.getW(gpstk::SatID(x, gpstk::SatID::systemGPS)) - aData.aop[i]) < eps))
            failCount++;
      }
      testMesg = "getW returned the wrong value";
      testFramework.assert(failCount == 0, testMesg, __LINE__);
      ...
      for (int i=0; i<31; i++)
      {
         ...
         if (!(std::abs(alm.getM0(gpstk::SatID(x, gpstk::SatID::systemGPS)) - aData.ma[i])*1E-1 < eps))
            failCount++;
      }
      testMesg = "getM0 returned the wrong value";
      testFramework.assert(failCount == 0, testMesg, __LINE__);
      ...
      for (int i=0; i<31; i++)
      {
         ...
         if (!(std::abs(alm.getAf0(gpstk::SatID(x, gpstk::SatID::systemGPS)) - aData.af0[i])*1E5 < eps))
            failCount++;
      }
      testMesg = "getAf0 returned the wrong value";
      testFramework.assert(failCount == 0, testMesg, __LINE__);
      ...
      for (int i=0; i<31; i++)
      {
         ...
         if (!(std::abs(alm.getAf1(gpstk::SatID(x, gpstk::SatID::systemGPS)) - aData.af1[i]) < eps))
            failCount++;
      }
      testMesg = "getAf1 returned the wrong value";
      testFramework.assert(failCount == 0, testMesg, __LINE__);
