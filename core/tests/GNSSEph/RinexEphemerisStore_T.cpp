...
#include "RinexEphemerisStore_T.hpp"
...
void xRinexEphemerisStore :: BCESfindEphTest (void)
{
	...
	CPPUNIT_ASSERT(fileEqualTest((char*)"Rinex_Logs/findEph1.txt",(char*)"Rinex_Checks/findEph1.chk"));
	CPPUNIT_ASSERT(fileEqualTest((char*)"Rinex_Logs/findEph15.txt",(char*)"Rinex_Checks/findEph15.chk"));
	CPPUNIT_ASSERT(fileEqualTest((char*)"Rinex_Logs/findEph32.txt",(char*)"Rinex_Checks/findEph32.chk"));
