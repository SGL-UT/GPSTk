...
public:
   ...
   int getSubframePatternTest(void)
   {
      ...
      testFramework.assert(gpstk::EngNav::getSubframePattern(subframe1P) == 1,
                           testMesg, __LINE__);
      testFramework.assert(gpstk::EngNav::getSubframePattern(subframe2P) == 2,
                           testMesg, __LINE__);
      testFramework.assert(gpstk::EngNav::getSubframePattern(subframe3P) == 3,
                           testMesg, __LINE__);
   ...
   int computeParityTest(void)
   {
      ...
      testFramework.assert(gpstk::EngNav::computeParity(data1, zero) == 0x24,
                           testMesg, __LINE__);

      data1 |= 0x24;

      testFramework.assert(gpstk::EngNav::computeParity(data2, data1) == 0x22,
                           testMesg, __LINE__);

      data2 |= 0x22;

      testFramework.assert(gpstk::EngNav::computeParity(data3, data2) == 0x1B,
                           testMesg, __LINE__);

      data3 |= 0x1B;

      testFramework.assert(gpstk::EngNav::computeParity(data4, data3, false) == 0x02,
                           testMesg, __LINE__);
   ...
   int fixParityTest(void)
   {
      ...
      testFramework.assert(gpstk::EngNav::fixParity(data1, 0, false) == CompareData1,
                           testMesg, __LINE__);
      testFramework.assert(gpstk::EngNav::fixParity(data2, CompareData1,
                           false) == CompareData2, testMesg, __LINE__);
      testFramework.assert(gpstk::EngNav::fixParity(data3, CompareData2,
                           false) == CompareData3, testMesg, __LINE__);

      testFramework.assert(gpstk::EngNav::fixParity(data4, CompareData3, false,
                           false) == CompareData4, testMesg, __LINE__);

      testFramework.assert(gpstk::EngNav::fixParity(data5, 0, true) == CompareData5,
                           testMesg, __LINE__);
   ...
   int checkParityTest(void)
   {
      ...
      testMesg = "Parity computed is incorrect";
      testFramework.assert(gpstk::EngNav::checkParity(subframe1P, false), testMesg,
                           __LINE__);
      testFramework.assert(gpstk::EngNav::checkParity(subframe2P, false), testMesg,
                           __LINE__);
      testFramework.assert(gpstk::EngNav::checkParity(subframe3P, false), testMesg,
                           __LINE__);
   ...
   int getHOWTimeTest(void)
   {
      ...
      testFramework.assert(gpstk::EngNav::getHOWTime(how1) == 409902, testMesg,
                           __LINE__);
      testFramework.assert(gpstk::EngNav::getHOWTime(how2) == 409908, testMesg,
                           __LINE__);
      testFramework.assert(gpstk::EngNav::getHOWTime(how3) == 409914, testMesg,
                           __LINE__);
   ...
   int subframeConvertTest(void) //calls getsubframePattern and convertQuant
   {
      ...
      testFramework.assert(EngNavThing.subframeConvert(subframe1P, 1025, output1),
                           testMesg, __LINE__);
