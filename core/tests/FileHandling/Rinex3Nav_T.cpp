...
void Rinex3Nav_T :: init( void )
{
    ...
    inputUnknownHeaderLabel  = dataFilePath + file_sep + "test_input_rinex2_nav_UnknownHeaderLabel.99n";
    inputIncompleteHeader    = dataFilePath + file_sep + "test_input_rinex2_nav_IncompleteHeader.99n";
    inputUnsupportedRinex    = dataFilePath + file_sep + "test_input_rinex2_nav_UnsupportedRinex.99n";
    inputBadHeader           = dataFilePath + file_sep + "test_input_rinex2_nav_BadHeader.99n";
    outputTestOutputHeader   = tempFilePath + file_sep + "test_output_rinex2_nav_TestOutputHeader.99n";

    inputFilterStream1       = dataFilePath + file_sep + "test_input_rinex2_nav_FilterTest1.99n";
    inputFilterStream2       = dataFilePath + file_sep + "test_input_rinex2_nav_FilterTest2.99n";
    inputFilterStream3       = dataFilePath + file_sep + "test_input_rinex2_nav_FilterTest3.99n";
    outputFilterOutput       = tempFilePath + file_sep + "test_output_rinex2_nav_FilterOutput.txt";

    outputRinexStore         = tempFilePath + file_sep + "test_output_rinex2_nav_RinexStore.txt";
...
int Rinex3Nav_T :: hardCodeTest( void )
{
  ...
  try
  {
    ...
    test1.assert( Rinex3NavHeader.version == CompareVersion,                  "RinexNav Header version comparison",      __LINE__ );
    test1.assert( Rinex3NavHeader.fileProgram == CompareFileProgram,          "RinexNav Header file program comparison", __LINE__ );
    test1.assert( Rinex3NavHeader.fileAgency == CompareFileAgency,            "RinexNav Header file agency comparison",  __LINE__ );
    test1.assert( Rinex3NavHeader.date == CompareDate,                        "RinexNav Header date comparison",         __LINE__ );

    std::vector<std::string>::const_iterator itr1 = Rinex3NavHeader.commentList.begin();
    test1.assert( (*itr1) == CompareComment, "RinexNav Header Comment comparison", __LINE__ );
...
int Rinex3Nav_T :: filterOperatorsTest( void )
{
    ...
    try
    {
      ...
      msg_test_desc = "Rinex3NavDataOperatorEqualsFull, EqualsFUll FilterData1 FilterData2, fail";
      test4.assert( EqualsFull( FilterData1, FilterData2 ), msg_test_desc, __LINE__ );
      msg_test_desc = "Rinex3NavDataOperatorEqualsFull, FilterData1 not equal FilterData3, fail";
      ...
      msg_test_desc = "Rinex3NavDataOperatorLessThanSimple, not LessThanSimple FilterData1 FilterData3, fail";
      ...
      msg_test_desc = "Rinex3NavDataOperatorLessThanFull, not LessThanFull FilterData1 FilterData1, fail";
