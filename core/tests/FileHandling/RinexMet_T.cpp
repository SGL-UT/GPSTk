...
void xRinexMet :: reallyPutRecordTest(void)
{
	...
	gpstk::RinexMetHeader RinexMetHeader;
	gpstk::RinexMetStream UnSupRinex("RinexMet_Logs/UnSupRinex.04m");
	gpstk::RinexMetStream MissingMarkerName("RinexMet_Logs/MissingMarkerName");
	gpstk::RinexMetStream output("RinexMet_Logs/ExtraOutput.txt", ios::out);
...
void xRinexMet :: reallyGetRecordTest(void)
{
	...
	gpstk::RinexMetStream Normal("RinexMet_Logs/408_110a.04m");

	//Bad Line Length Met file (Add a space characacter to the end of the first line)
	gpstk::RinexMetStream BLL("RinexMet_Logs/BLL.04m");

	//Not a Met File (Change Met to zet in first line)
	gpstk::RinexMetStream NMF("RinexMet_Logs/NotMetFile.04m");

	//Bad Obs line (Add in something between the MET obs besides space)
	gpstk::RinexMetStream BOL("RinexMet_Logs/BOL.04m");

	//Bad Sesor Type line, Format Error
	gpstk::RinexMetStream FER("RinexMet_Logs/FER.04m");

	//Extra header line with HEADERLINE2
	gpstk::RinexMetStream ExtraH("RinexMet_Logs/ExtraH.04m");

	//Unsupported Rinex Version (3.30)
	gpstk::RinexMetStream UnSupRinex("RinexMet_Logs/UnSupRinex.04m");

	//Missing SensorPos
	gpstk::RinexMetStream MissingSPos("RinexMet_Logs/MissingEOH.04m");

	//Error in the part of the header which holds the list of observations within the Met file
	gpstk::RinexMetStream ObsHeaderStringError("RinexMet_Logs/ObsHeaderStringError.04m");

	//Error in the sensor type
	gpstk::RinexMetStream SensorType("RinexMet_Logs/SensorTypeError.04m");
...
void xRinexMet :: hardCodeTest (void)
{
	...
	gpstk::RinexMetStream RinexMetStream("RinexMet_Logs/408_110a.04m");
	gpstk::RinexMetStream out("RinexMet_Logs/Output.txt",ios::out);
	gpstk::RinexMetHeader RinexMetHeader;
	...
	CPPUNIT_ASSERT(fileEqualTest((char*)"RinexMet_Logs/408_110a.04m",(char*)"RinexMet_Logs/Output.txt"));

	gpstk::RinexMetStream MetDumps("RinexMet_Logs/MetDumps",ios::out);
...
void xRinexMet :: continuationTest (void)
{
		...
		gpstk::RinexMetStream RinexMetStream("RinexMet_Logs/ContLines10.04m");
		gpstk::RinexMetStream out("RinexMet_Logs/OutputCont.txt",ios::out);
		gpstk::RinexMetStream MetDumps("RinexMet_Logs/MetDumps",ios::out);
		gpstk::RinexMetHeader RinexMetHeader;
		gpstk::RinexMetData RinexMetData;
	try
	{
		...
		CPPUNIT_ASSERT(fileEqualTest((char*)"RinexMet_Logs/ContLines10.04m",(char*)"RinexMet_Logs/OutputCont.txt"));
	}
	catch (gpstk::Exception& e)
	{
		cout << e;
...
{
		gpstk::RinexMetStream NoObs("RinexMet_Logs/NoObsData.04m");
		gpstk::RinexMetStream InvalidTimeFormat("RinexMet_Logs/InvalidTimeFormat.04m");
		gpstk::RinexMetStream out("RinexMet_Logs/OutputDataExceptions.txt",ios::out);
...
void xRinexMet :: filterOperatorsTest (void)
{
	try
	{
		...
		gpstk::RinexMetStream FilterStream1("RinexMet_Logs/FilterTest1.04m");
		FilterStream1.open("RinexMet_Logs/FilterTest1.04m",std::ios::in);
		gpstk::RinexMetStream FilterStream2("RinexMet_Logs/FilterTest2.04m");
		gpstk::RinexMetStream FilterStream3("RinexMet_Logs/FilterTest3.04m");
		gpstk::RinexMetStream FilterStream4("RinexMet_Logs/FilterTest4.04m");
		gpstk::RinexMetStream out("RinexMet_Logs/FilterOutput.txt",ios::out);
