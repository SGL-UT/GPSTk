	...
	public:
		...
		int xvtTest (void)
		{
			...
			Triple XYZ, rotatedXYZ;
		   	...
		   	if (0.0 != rotatedTestPoint.clkbias) return 3;
		   	if (0.0 != rotatedTestPoint.clkdrift) return 4;
		   	...
		   	if (0.0 != rotatedTestPoint.clkbias) return 8;
		   	if (0.0 != rotatedTestPoint.clkdrift) return 9;
