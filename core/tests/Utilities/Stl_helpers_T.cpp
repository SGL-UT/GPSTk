...
//========================================================================================
	...
	{
		TestUtil testFramework("stl_helpers", "Max and Min", __FILE__, __LINE__);
		std::string testMesg;
...
//=========================================================================================
	int statsTest(void)
	{
		TestUtil testFramework("stl_helpers", "Stats", __FILE__, __LINE__);
		std::string testMesg;
...
//==================================================================================================
	...
	{
		TestUtil testFramework("stl_helpers", "VectorIndex", __FILE__, __LINE__);
		std::string testMesg;
