...
\ExecuteOptions{letterpaper,10pt,twoside,onecolumn,final,openleft} %openright to openleft
\ProcessOptions
...
\if@twoside
  \def\ps@headings{%
      ...
      \def\@evenhead{\thepage\hfil\slshape\rightmark}% switched
