...
All JD and GPS Week equations were found here~\cite[pp. 36-37]{hlc:gtp$chap2}.
...
where $a$, the semimajor axis, is the value of the mean equatorial radius of Earth (6,378.137 km) and $b$, the semiminor axis, is the value of the polar radius of Earth (6,356.7523142 km) \cite[pp. 25-26]{kaplan:ugpspa$chap2}.
...
\end{array}
\right] \]
where $\mathbf{u}$ is the user's position vector~\cite[pp. 26-28, p. 76]{kaplan:ugpspa$chap2,me:gsmp$chap2}.
