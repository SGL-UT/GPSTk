#pragma ident "$Id: Rinex3MetFilterOperators.hpp 1709 2009-02-18 20:27:47Z btolman $"
...
namespace gpstk
{
   ...
   struct Rinex3MetDataOperatorLessThanFull : public Rinex3MetDataBinaryOperator
   {
   public:
     ...
     {
       // Compare the times, offsets, then only those elements that are
       // common to both.  This ignores the flags that are set to 0.
       if (l.time < r.time)
         return true;
       ...
       gpstk::Rinex3MetData::Rinex3MetMap::const_iterator lItr, rItr;
       std::set<gpstk::Rinex3MetHeader::Rinex3MetType>::const_iterator obsItr = obsSet.begin();
   ...
   /// Compares only times
   struct Rinex3MetDataOperatorLessThanSimple : public Rinex3MetDataBinaryOperator
   {
   public:
   ...
   /// Compares only times
   struct Rinex3MetDataOperatorEqualsSimple : public Rinex3MetDataBinaryOperator
   {
   public:
   ...
   struct Rinex3MetHeaderTouchHeaderMerge : public Rinex3MetDataUnaryOperator
   {
   public:
     ...
     bool operator()(const gpstk::Rinex3MetHeader& l)
     {
       ...
       {
         std::set<gpstk::Rinex3MetHeader::Rinex3MetType> thisMetSet, tempMetSet;
