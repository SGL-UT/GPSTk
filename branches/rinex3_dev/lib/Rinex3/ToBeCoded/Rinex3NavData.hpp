...
#ifndef RINEX3NAVDATA_HPP
#define RINEX3NAVDATA_HPP
...
namespace gpstk
{
   ...
   //@{
      ...
      /** 
       * This class models a RINEX3 NAV record.
       *
   ...
   public:
      ...
      short weeknum;       ///< GPS full week number that corresponds 
                           ...
                           ///< (NB in Rinex3 files, week number corresponds to TOE)
      ...
      double IODE;         ///< Index of data-eph 
          ...
          */
         //@{
      double   Toc;           ///< Clock epoch (sec of week) (found in epoch line of Rinex3 navigation files)
   ...
   protected:
      ...
      virtual void reallyPutRecord(FFStream& s) const 
         ...
         /** 
          * This function retrieves a RINEX3 NAV record from the given FFStream.
