...
namespace gpstk
{
   ...
   //@{
      ...
      /**
       * This class models the RINEX3 NAV header for a RINEX3 NAV file.
       *
   ...
   public:
      ...
      unsigned long valid;
         ...
         /// These are validity bits used in checking the RINEX3 NAV header.
      enum validBits
      {
   ...
   protected:
      ...
      virtual void reallyPutRecord(FFStream& s) const
         ...
         /**
          * This function reads the RINEX3 NAV header from the given FFStream.
