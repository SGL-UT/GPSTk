 ...
 * Encapsulate RINEX3 observation file data, including I/O
 */
...
namespace gpstk
{
   ...
   //@{
      ...
      /**
       * This class models a RINEX3 Observation Data Record.
       *
   ...
   public:
         ...
         /// A structure used to store a single RINEX3 Data point.
      struct Rinex3Datum
      {
         Rinex3Datum() : data(0), lli(0), ssi(0) {}
         double data;  ///< The actual data point.
         short lli;    ///< See the RINEX3 Spec. for an explanation.
         short ssi;    ///< See the RINEX3 Spec. for an explanation.
      };
      
         /// map from ObsID to Rinex3Datum.
      typedef std::map<Rinex3ObsHeader::ObsID, Rinex3Datum> ObsIDMap;
         /// map from SatID to ObsIDMap.
      typedef std::map<SatID, ObsIDMap> Rinex3SatMap;
      ...
      Rinex3SatMap obs;         ///< the map of observations
      ...
      virtual ~Rinex3ObsData() {}
         ...
         /// Rinex3ObsData is a "data", so this function always returns true.
   ...
   protected:
      ...
      virtual void reallyPutRecord(FFStream& s) const 
         ...
         /**
          * This functions obtains a RINEX3 Observation record from the given 
          * FFStream.
          * If there is an error in reading from the stream, it is reset
          * to its original position and its fail-bit is set.
          * Because of the Rinex3 Obs format, a Rinex3ObsData record returned
          * might not have data in it.  Check the Rinex3SatMap for empty()
   ...
   private:
         /// Writes the daytime object into RINEX3 format. If it's a bad time,
      ...
      std::string writeTime(const CommonTime& dt) const
          ...
          * @param line the encoded time string found in the RINEX3 record.
          * @param hdr the RINEX3 Observation Header object for the current RINEX3 file.
          */
      CommonTime parseTime(const std::string& line, const Rinex3ObsHeader& hdr) const
         throw(FFStreamError);
   }; // class Rinex3ObsData
