...
//------------------------------------------------------------------------------------
   ...
   namespace Robust
   {
      ...
      T MEstimate(const T *xd, int nd, const T& M, const T& MAD, T *w=NULL)
      {
          ...
          * @param[in] xd array of data, of length nd; contains
          *   residuals on output.
          * @param[in] td array of independent variable, length nd
          *   (parallel to xd).
          * @param[in] nd length of arrays xd and td.
          * @param[in] n degree of polynomial and dimension of
          *   coefficient array.
          * @param[out] c array of coefficients (dimension n).
          * @param[out] w array of length nd to contain weights.
          * @return 0 for success, -1 for singular problem, -2 failure
          *   to converge.
          * @throw Exception
          */
