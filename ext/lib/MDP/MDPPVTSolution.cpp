...
namespace sgltk
{
      ...
      throw()
   {
      ...
      str += encodeVar<uint16_t>(static_cast<gpstk::GPSWeekSecond>(time).week);
      str += encodeVar<double>(static_cast<gpstk::GPSWeekSecond>(time).sow);
      ...
      throw()
   {
      ...
      timep = gpstk::GPSWeekSecond(week, sow);
