...
namespace sgltk
{
   ...
   class MDPHeader : public gpstk::FFData, public gpstk::CRCDataStatus
   {
   public:
      MDPHeader() throw() : id(0),length(0),crc(0),
         time(gpstk::CommonTime(gpstk::TimeSystem::GPS ))
      {length=myLength;}
      ...
      void setCRC(std::string& str) const throw(gpstk::FFStreamError);
