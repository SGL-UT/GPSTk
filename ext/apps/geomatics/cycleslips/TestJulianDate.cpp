 ...
 //compute(string("2457222.5011458333333333"),prec);
   ...
   cout << " timecon " << timecon.asString(19) << std::endl;
      ...
      cout << setw(15) << "char :"
           ...
           << " " << setw(14) << (int)numeric_limits<char>::min()
           << " " << setw(15) << (int)numeric_limits<char>::max()
           << endl;
      cout << setw(15) << "unsigned char :"
           ...
           << " " << setw(14) << (int)numeric_limits<unsigned char>::min()
           << " " << setw(15) << (int)numeric_limits<unsigned char>::max()
           << endl;
      cout << setw(15) << "int :"
           << setw(6) << sizeof(int)
      ...
      cout << setw(15) << "unsigned int :"
           ...
           << " " << setw(14) << numeric_limits<unsigned int>::min()
      ...
      cout << setw(15) << "long :"
           ...
           << " " << setw(14) << numeric_limits<long>::min()
           << " " << setw(15) << numeric_limits<long>::max()
           << endl;
      cout << setw(15) << "unsigned long :"
           ...
           << " " << setw(14) << numeric_limits<unsigned long>::min()
           << " " << setw(15) << numeric_limits<unsigned long>::max()
           << endl;
      cout << setw(15) << "uint64_t :"
           ...
           << " " << setw(14) << numeric_limits<uint64_t>::min()
           << " " << setw(15) << numeric_limits<uint64_t>::max()
           << endl;
      ...
      cout << setw(15) << "short :"
           ...
           << " " << setw(14) << numeric_limits<short>::min()
           << " " << setw(15) << numeric_limits<short>::max()
           << setw(13) << "epsilon"
      ...
      cout << setw(15) << "long double :"
           ...
           << " " << setw(14) << numeric_limits<long double>::min()
           << " " << setw(15) << numeric_limits<long double>::max()
